/**
 * BusinessCardHorizontal — V2 spec: Logo, Business Name, City · Province, Rating.
 * Full-width horizontal layout used in Search, Map, and Account saved lists.
 */
...
export function BusinessCardHorizontal({
  ...
  return (
    <motion.div
      className={cn(
        "card flex items-center gap-3 px-4 py-3 cursor-pointer",
        className
      )}
      whileTap={{ scale: 0.98 }}
